...
The packages in the `lanelet2` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble lanelet2 --override-release-repository-push-url git@github.com:revyos-ros/lanelet2-release.git` on `Sat, 14 Dec 2024 08:31:11 -0000`
...
- release repository: https://github.com/revyos-ros/lanelet2-release.git
...
## lanelet2 (humble) - 1.2.1-2

The packages in the `lanelet2` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble lanelet2` on `Tue, 07 May 2024 01:52:02 -0000`
